...
<div class="row-fluid">
  <div class="span12">
    ...
    <p>Dear <?php echo $participant_array["firstname"];
            echo " ";
            echo $participant_array["lastname"]; ?>,</p>
        ...
        <div id="update_section" class="control-group">
          ...
          <div class="controls">
            ...
            <select id="interested" name="interested" class="span2">
              <option value=0 <?php if ($int == 0) {
                                echo "selected=\"selected\"";
                              } ?>>&nbsp;</option>
              <option value=1 <?php if ($int == 1) {
                                echo "selected=\"selected\"";
                              } ?>>Yes</option>
              <option value=2 <?php if ($int == 2) {
                                echo "selected=\"selected\"";
                              } ?>>No</option>
            </select>
          </div>
