...
<xsl:stylesheet version="1.0"
 ...
 -                    <xsl:value-of select="@endtime" />
                ...
                <div class="inforow">in <xsl:value-of select="@roomname" />
                </div>
            </xsl:when>
            <xsl:otherwise>
            ...
            <xsl:when test="/doc/query[@queryName='participants']/row">
                ...
                <xsl:choose>
                    <xsl:when test="$modrow">
                        ...
                        <div class="inforow">
                            <xsl:value-of select="$modrow/@badgename" />
 (                            <xsl:value-of select="$modrow/@badgeid" />
)                            <xsl:value-of select="$modrow/@participantname" />
                        </div>
                    </xsl:when>
                    <xsl:otherwise>
