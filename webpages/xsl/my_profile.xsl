...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <xsl:variable name="conName">
      <xsl:value-of select="/doc/options/@conName"/>
    </xsl:variable>
    <xsl:variable name="enableBioEdit">
      <xsl:value-of select="/doc/options/@enableBioEdit"/>
    </xsl:variable>
    <xsl:variable name="interested">
      <xsl:value-of select="/doc/query[@queryName='participant_info']/row/@interested"/>
    </xsl:variable>
    <xsl:variable name="share_email">
      <xsl:value-of select="/doc/query[@queryName='participant_info']/row/@share_email"/>
    </xsl:variable>
    <xsl:variable name="use_photo">
      <xsl:value-of select="/doc/query[@queryName='participant_info']/row/@use_photo"/>
    </xsl:variable>
    <xsl:variable name="bestway">
      <xsl:value-of select="/doc/query[@queryName='participant_info']/row/@bestway"/>
    </xsl:variable>
    <xsl:variable name="bioNote">
      <xsl:value-of select="/doc/customText/@biography_note"/>
    </xsl:variable>
    <xsl:variable name="regURL">
      <xsl:value-of select="/doc/options/@reg_url"/>
    </xsl:variable>
    <script type="text/javascript">var maxBioLen = <xsl:value-of select="/doc/options/@maxBioLen"/>
;</script>
        ...
        <form name="partform" class="form-horizontal" method="POST" action="SubmitMyContact.php">
          <fieldset>
            ...
            <div class="control-group">
              <label for="interested" class="control-label nowidth">I am interested and able to participate in programming for <xsl:value-of select="$conName"/>
:</label>
              <div class="controls">
                <select id="interested" name="interested" class="yesno span2" onchange="myProfile.anyChange('interested');" onkeyup="myProfile.anyChange('interested')">
                  <option value="0">
          ...
          <xsl:choose>
            <xsl:when test="/doc/options/@enable_share_email_question">
              <fieldset>
                <div class="control-group">
                  <label for="share_email" class="control-label nowidth">I give permission for <xsl:value-of select="$conName"/>
 to share my email address with other participants:</label>
                  <div class="controls">
                    <select id="share_email" name="share_email" class="span2" onchange="myProfile.anyChange('share_email')" onkeyup="myProfile.anyChange('share_email')">
                      <option value="null">
          ...
          <xsl:choose>
            <xsl:when test="/doc/options/@enable_use_photo_question">
              <fieldset>
                <div class="control-group">
                  <label for="use_photo" class="control-label">I give permission for <xsl:value-of select="$conName"/>
 to photograph me while I am on panels and to use those
				  images in the promotion of the convention: <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                </label>
                <div class="controls">
                  <select id="use_photo" name="use_photo" class="span2" onchange="myProfile.anyChange('use_photo')" onkeyup="myProfile.anyChange('use_photo')">
                    <option value="null">
          ...
          <xsl:when test="/doc/options/@enable_bestway_question">
            ...
            <div class="verticalRadioButs">
              <div class="radioNlabel">
                <span class="radio">
                  <input name="bestway" id="bwemailRB" value="Email" type="radio" onchange="myProfile.anyChange('bestway')" onkeyup="myProfile.anyChange('bestway')">
              ...
              <div class="radioNlabel">
                <span class="radio">
                  <input name="bestway" id="bwpmailRB" value="Postal mail" type="radio" onchange="myProfile.anyChange('bestway')" onkeyup="myProfile.anyChange('bestway')">
              ...
              <div class="radioNlabel">
                <span class="radio">
                  <input name="bestway" id="bwphoneRB" value="Phone" type="radio" onchange="myProfile.anyChange('bestway')" onkeyup="myProfile.anyChange('bestway')">
        ...
        <fieldset>
          <div class="control-group" id="passGroup">
            ...
            <div class="controls">
              ...
              <span id="badPassword" class="help-inline">
                <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>Passwords don't match!</span>
            </div>
          </div>
        </fieldset>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input type="text" size="20" name="pubsname" value="{/doc/query[@queryName='participant_info']/row/@pubsname}" id="pubsname" onchange="myProfile.anyChange('pubsname')" onkeyup="myProfile.anyChange('pubsname')" class="userFormINPTXT">
              <xsl:if test="$enableBioEdit!='1'">
        ...
        <div class="control-group" id="bioGroup">
          <label for="bio">Your biography (<xsl:value-of select="/doc/options/@maxBioLen"/>
 characters or fewer including spaces):</label>
          <div>
            <textarea class="span12" rows="5" cols="72" name="bio" id="bioTXTA" onchange="myProfile.anyChange('bioTXTA')" onkeyup="myProfile.anyChange('bioTXTA')">
              <xsl:choose>
            ...
            <div>
              <xsl:for-each select="/doc/query[@queryName='credentials']/row">
                ...
                <label class="checkbox">
                  ...
                  <input class="checkbox" id="credentialCHK{@credentialid}" type="checkbox" onchange="myProfile.anyChange('credentialCHK{@credentialid}')" onkeyup="myProfile.anyChange('credentialCHK{@credentialid}')">
                    <xsl:if test="@badgeid">
...
,
              ...
              <div class="pull-left span7">
                <p class="congo_table">Please confirm your contact information.  If it is not correct, please log into <xsl:value-of select="$conName"/>
's
