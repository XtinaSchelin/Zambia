...
// Copyright (c) 2008-2019 Peter Olszowka. All rights reserved.
// See copyright document for more details.

// Basics about the con.
define("DBHOSTNAME", "localhost");
define("DBUSERID", "zambiademo");
define("DBPASSWORD", "4fandom");
define("DBDB", "readercon_db");
define("CON_NAME", "Readercon");
define("CON_NUM", "31");
define("BRAINSTORM_EMAIL", "brain@somewhere.net");
define("PROGRAM_EMAIL", "program@somewhere.net");
define("LOGO_FILENAME", "readercon_logo.jpg"); // assumes the file is in the images directory
define("REG_URL", "http://program.readercon.org"); // URL for logging into user self service portion of registration system -- appears on My Profile page
...
define("CON_START_DATIM", "2021-08-06 00:00:00"); // Broadly used.  Must be in mysql format: "YYYY-MM-DD HH:MM:SS" (HH:00-23) HH:MM:SS probably should be 00:00:00
...
// Preferences and field enablements.
