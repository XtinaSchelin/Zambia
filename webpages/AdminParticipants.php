...
<div>
  <div class="row-fluid" id="resultsDiv">
    <div class="span1">
      ...
      <div class="newforminput"><input class="span12 disabled" id="badgeid" type="text" readonly="readonly" size="8" /></div>
    </div>
    <div class="span3">
      <div class="newformlabel"><label for="lname_fname" class="newformlabel">Last name, first name:</label></div>
      <div class="newforminput"><input class="span12 disabled" id="lname_fname" type="text" readonly="readonly" size="35" /></div>
    </div>
    <div class="span3">
      <div class="newformlabel"><label for="bname" class="newformlabel">Badge name:</label></div>
      <div class="newforminput"><input class="span12 disabled" id="bname" type="text" readonly="readonly" size="12" /></div>
    </div>
    <div class="span3">
      <div class="newformlabel"><label for="pname" class="newformlabel">Name for publications:</label></div>
      <div class="newforminput"><input class="span12" id="pname" type="text" readonly="readonly" size="35" onchange="textChange('pname');" onkeyup="textChange('pname');" /></div>
    </div>
    <div class="row-fluid">
      <div class="span12 borderBox" xxstyle="padding: 4px; border: 1px solid gray;">
    ...
    <div class="row-fluid" style="margin-top: 1em">
      ...
      <div class="span4">
        ...
        <div class="newforminput">
          <div id="partRoles" class="divbox" style="height: 3em; width: 25em; overflow: auto"></div>
        </div>
      </div>
    </div>
    <div class="row-fluid">
      <div class="span6">
        ...
        <div class="newforminput"><textarea class="span12" id="bio" rows="4" cols="80" readonly="readonly" onchange="textChange('bio');" onkeyup="textChange('bio');"></textarea></div>
      </div>
      <div class="span6">
        <div class="newformlabel"><label for="staffnotes" class="newformlabel">Staff notes re. participant:</label></div>
        <div class="newforminput"><textarea class="span12" id="staffnotes" rows="4" cols="80" readonly="readonly" onchange="textChange('snotes');" onkeyup="textChange('snotes');"></textarea></div>
      </div>
    </div>
