...
?>
  ...
  <div class="control-group">
    ...
    <INPUT type=text class="span4" size="50" name="title" value="<?php echo htmlspecialchars($session["title"], ENT_COMPAT) . "\">"; ?>&nbsp;&nbsp;
              <INPUT class=" checkbox adjust" type="checkbox" value="invguest" id="invguest" <?php if ($session["invguest"]) {
                                                                                                echo " checked ";
                                                                                              } ?> name="invguest">
    <label class="checkbox inline" for="invguest"> Invited Guests Only</LABEL>&nbsp;&nbsp;&nbsp;
    <INPUT class="checkbox adjust" type="checkbox" value="signup" id="signup" <?php if ($session["signup"]) {
                                                                                echo " checked ";
                                                                              } ?> name="signup">
  ...
  <DIV class="row-fluid">
    <DIV class="span5">
      ...
      <DIV class="borderBox">
        ...
        <div class="clearfix">
          ...
          <div class="span2">
            <BUTTON class="btn" onclick="fadditems(document.sessform.featsrc,document.sessform.featdest)" name="additems" value="additems" type="button">&nbsp;&rarr;&nbsp;</BUTTON>
            <BUTTON class="btn" onclick="fdropitems(document.sessform.featsrc,document.sessform.featdest)" name="dropitems" value="dropitems" type="button">&nbsp;&larr;&nbsp;</BUTTON>
          </div>
    ...
    <DIV class="span5" style="float: left;">
      ...
      <DIV class="borderBox">
        ...
        <div class="clearfix">
          ...
          <div class="span2">
            <BUTTON class="btn" onclick="fadditems(document.sessform.servsrc,document.sessform.servdest)" name="additems" value="additems" type="button">&nbsp;&rarr;&nbsp;</BUTTON>
            <BUTTON class="btn" onclick="fdropitems(document.sessform.servsrc,document.sessform.servdest)" name="dropitems" value="dropitems" type="button">&nbsp;&larr;&nbsp;</BUTTON>
          </div>
    ...
    <DIV class="span2" style="float: left;">
      <LABEL class="control-label" for="pubchardest">Characteristics:
        <SELECT class="span12" id="pubchardest" name="pubchardest[]" multiple><?php populate_multiselect_from_table(
                                                                                "PubCharacteristics",
                                                                                $session["pubchardest"]
                                                                              ); ?>
        </SELECT>
  ...
  <div class="row-fluid form-vertical">
    <div class="span4">
      ...
      <TEXTAREA class="textlabelarea span12" cols=70 name="notesforpart"><?php echo htmlspecialchars($session["notesforpart"], ENT_NOQUOTES); ?></TEXTAREA>
    </div>
    <div class="span4">
      <LABEL class="control-label" for="servnotes">Notes for Tech and Hotel:</LABEL>
      <TEXTAREA class="textlabelarea span12" cols=70 name="servnotes"><?php echo htmlspecialchars($session["servnotes"], ENT_NOQUOTES); ?></TEXTAREA>
    </div>
    <div class="span4">
      <LABEL class="control-label" for="notesforprog">Notes for Programming Committee:</LABEL>
      <TEXTAREA class="textlabelarea span12" cols=70 name="notesforprog"><?php echo htmlspecialchars($session["notesforprog"], ENT_NOQUOTES); ?></TEXTAREA>
    </div>
  </div>
  <div id="buttonBox" class="clearfix">
    <div class="pull-right">
