      ...
      <TABLE>
        <TR>
          <TD class="form1">
            ...
            <INPUT TYPE="TEXT" NAME="name" onKeyPress="return checkSubmitButton();" <?php if ($name != "")
                                                                                      echo "value=\"$name\" "; ?>>
          </TD>
        </TR>
        <TR>
          <TD class="form1">&nbsp;<BR>
            ...
            <INPUT TYPE="TEXT" NAME="email" size="50" onKeyPress="return checkSubmitButton();" <?php if ($email != "")
                                                                                                  echo "value=\"$email\" "; ?>>
          </TD>
        </TR>
        <TR>
